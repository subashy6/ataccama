...
@rem wrapper script for running class in map-reduce context
...
if "%LAUNCH%" == "" set LAUNCH=com.ataccama.dqc.hadoop.launch.LaunchModelRL
...
set CLASSPATH="%MAINCP%";%CLASSPATH%
...
"%JAVA_EXE%" -classpath %CLASSPATH% %DEBUG_OPT% %CLASS% %PROPF% %LAUNCH% %ARGS%