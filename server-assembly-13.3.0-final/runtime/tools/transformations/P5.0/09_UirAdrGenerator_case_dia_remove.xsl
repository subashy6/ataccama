...
<xsl:stylesheet version="1.0"
	...
	ver:name="Removes caseInsensitive and diaInsensitive UirAdrGenerator/replacements">
	
	<xsl:template match="step[@className='cz.adastra.cif.tasks.uiradr.UirAdrGenerator']/properties/replacements/*/@caseInsensitive">
		<xsl:call-template name="reportRemoved"/>
	</xsl:template>
	<xsl:template match="step[@className='cz.adastra.cif.tasks.uiradr.UirAdrGenerator']/properties/replacements/*/caseInsensitive">
		<xsl:call-template name="reportRemoved"/>
	</xsl:template>
	<xsl:template match="step[@className='cz.adastra.cif.tasks.uiradr.UirAdrGenerator']/properties/replacements/*/@diaInsensitive">
		<xsl:call-template name="reportRemoved"/>
	</xsl:template>
	<xsl:template match="step[@className='cz.adastra.cif.tasks.uiradr.UirAdrGenerator']/properties/replacements/*/diaInsensitive">
		<xsl:call-template name="reportRemoved"/>
