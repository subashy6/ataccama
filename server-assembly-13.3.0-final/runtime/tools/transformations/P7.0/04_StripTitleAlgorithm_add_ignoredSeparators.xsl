...
<xsl:stylesheet version="1.0"
	...
	ver:name="Removes specialsSensitive parameter and sets up ignoredSeparators for Strip Titles">

	<!-- remove specialsSensitive parameter -->
	<xsl:template match="step[@className='cz.adastra.cif.tasks.clean.StripTitlesAlgorithm']/properties/@specialsSensitive">
	</xsl:template>
	<xsl:template match="step[@className='cz.adastra.cif.tasks.clean.StripTitlesAlgorithm']/properties/specialsSensitive">
	</xsl:template>

	<xsl:template match="step[@className='cz.adastra.cif.tasks.clean.StripTitlesAlgorithm']/properties">
		<xsl:copy>
